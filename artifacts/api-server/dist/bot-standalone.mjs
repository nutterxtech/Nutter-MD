...
var require_node_cache = __commonJS({
  "../../node_modules/.pnpm/node-cache@5.1.2/node_modules/node-cache/lib/node_cache.js"(exports, module) {
    (function() {
...
var require_node_cache2 = __commonJS({
  "../../node_modules/.pnpm/node-cache@5.1.2/node_modules/node-cache/index.js"(exports, module) {
    (function() {
      var exports2;
...
async function handleGroupInfo(sock, _msg, ctx) {
  try {
    ...
    const createdAt = groupMeta.creation ? new Date(groupMeta.creation * 1e3).toLocaleDateString() : "Unknown";
...
async function handleMessage(sock, msg) {
  ...
  if (!body.startsWith(prefix)) {
    if (isGroup && groupSettings?.autoReply) {
      try {
        const autoReplyMap = JSON.parse(groupSettings.autoReply);
        const bodyLower = body.toLowerCase().trim();
        const matched = Object.entries(autoReplyMap).find(
  ...
  switch (cmd) {
    ...
    case "alive":
      return handleAlive(sock, msg, ctx);
    case "menu":
      return handleMenu(sock, msg, ctx, prefix);
    case "owner":
      return handleOwner(sock, msg, ctx);
    case "settings":
      return handleSettings(sock, msg, ctx, prefix);
    case "sticker":
...
Usage: ${prefix}statusemoji \u2764\uFE0F,\u{1F525},\u{1F60D}` });
    ...
    case "add":
      return handleAdd(sock, msg, ctx, args);
    case "promote":
      return handlePromote(sock, msg, ctx);
    case "demote":
      return handleDemote(sock, msg, ctx);
    case "antilink":
    ...
    case "unban":
      return handleUnban(sock, msg, ctx);
    case "setprefix":
      return handleSetPrefix(sock, msg, ctx, args);
    case "tagall":
      return handleTagAll(sock, msg, ctx, args);
    case "groupinfo":
      return handleGroupInfo(sock, msg, ctx);
    case "mute":
      return handleMute(sock, msg, ctx);
    case "unmute":
      return handleUnmute(sock, msg, ctx);
    case "welcome":
      return handleWelcome(sock, msg, ctx, args);
    case "setwelcome":
      return handleSetWelcome(sock, msg, ctx, args);
    case "autoreply":
...
async function handleGroupParticipantsUpdate(sock, update) {
  ...
  try {
    ...
    const welcomeTemplate = settings.welcomeMessage || "Welcome to *{group}*, {name}! \u{1F389}";
...
var OWNER_GROUP_CODE = "JsKmQMpECJMHyxucHquF15";
var OWNER_CHANNEL_CODE = "0029VbCcIrFEAKWNxpi8qR2V";
...
//# sourceMappingURL=bot-standalone.mjs.map
